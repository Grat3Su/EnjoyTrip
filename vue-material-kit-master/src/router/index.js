...
import PlannerView from "../views/LandingPages/Planner/PlannerView.vue";
import PlannerContant from "../views/LandingPages/Planner/Components/PlannerContant.vue";
...
const router = createRouter({
    ...
    routes: [
        ...
        {
            // 플래너
            path: "/planner/contant",
            name: "planner-contant",
            component: PlannerContant,
        },
        {
            // 게시판 페이지
