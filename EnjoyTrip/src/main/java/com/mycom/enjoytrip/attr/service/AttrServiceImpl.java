...
public class AttrServiceImpl implements AttrService{
	...
	@Override
	public List<Integer> likeList(int userId) {
		// TODO Auto-generated method stub
		return dao.likeList(userId);
	}
	
	@Override
	public List<LikeDto> likeDetailList(int userId) {
		// TODO Auto-generated method stub
		return dao.likeDetailList(userId);
	}

	@Override
	public int likeInsert(int userId, int contentId) {
		// TODO Auto-generated method stub
		return dao.likeInsert(userId, contentId);
	}

	@Override
	public int likeDelete(int userId, int contentId) {
		// TODO Auto-generated method stub
